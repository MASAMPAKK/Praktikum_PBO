...
// Subclass 3 + implements Interface
class JadwalEksekutif extends JadwalKereta implements Promo {
    ...
    public void tampilkanPromo() {
        System.out.println("Promo: Diskon Rp " + hitungDiskon() + " untuk kelas eksekutif!");
    }
}
...
public class KeretaApiCRUD {
    ...
    private static int totalJadwal = 0;
    ...
    private static void incrementTotalJadwal() {
        totalJadwal++;
    }

    private static void showTotalJadwal() {
        System.out.println("Total Jadwal yang Tersedia: " + totalJadwal);
    }
}
