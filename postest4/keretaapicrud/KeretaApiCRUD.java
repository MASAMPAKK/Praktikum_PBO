...
// Subclass 1
class JadwalEkonomi extends JadwalKereta {
...
public class KeretaApiCRUD {
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            switch (choice) {
                case 1 -> tambahJadwal(); // Overloaded versi 1
                case 2 -> lihatJadwal();
                case 3 -> updateJadwal();
                case 4 -> hapusJadwal();
                case 5 -> {
    ...
    // Overloading: versi tanpa parameter
    private static void tambahJadwal() {
        tambahJadwal(100); // Default 100 kursi
    }

    // Overloading: versi dengan parameter default kursi
    ...
    private static void lihatJadwal() {
        if (jadwalList.isEmpty()) {
            ...
            for (JadwalKereta jadwal : jadwalList) {
                jadwal.display(); // Polymorphism: method yang di-override dipanggil sesuai objek
            }
        }
    }
